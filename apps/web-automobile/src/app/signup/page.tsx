    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center px-4 py-16">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Join Eldovia Automobile</h1>
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Create your account to start bidding and listing</p>
        </div>
