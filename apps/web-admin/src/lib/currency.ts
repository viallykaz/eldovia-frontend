// Rates fetched once per hour from a free, no-key-required API (160+ currencies including GHS)
...
// All rates are relative to USD, so convert via USD as the intermediate
