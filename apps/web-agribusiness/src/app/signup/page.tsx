    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center px-4 py-16">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Join Eldovia Agribusiness</h1>
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Create your account to invest and grow</p>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-white/10 p-8">
          ...
          <p className="text-center text-sm text-gray-500 dark:text-gray-400 mt-6">
            ...
            <Link href="/signin" className="text-green-600 hover:underline font-medium">Sign in</Link>
          </p>
        </div>
